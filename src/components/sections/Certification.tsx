    ...
    <section className="bg-brand-dark py-16 px-4 md:px-8 lg:px-16">
      <div className="max-w-6xl mx-auto">
        <motion.div
          ...
          className="relative rounded-3xl overflow-hidden border border-brand-yellow/20 shadow-[0_0_60px_rgba(242,190,27,0.12)] bg-gradient-to-br from-brand-yellow/5 to-transparent p-8 md:p-12"
        >
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Button
                  variant="outline"
                  href="https://cialdini.com/certified-practitioner"
                  external
                >
                  Más información
                </Button>
