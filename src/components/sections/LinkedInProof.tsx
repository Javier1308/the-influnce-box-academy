      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-[auto_1fr_auto]">
            ...
            {/* Logo */}
            <div className="flex items-center justify-center p-4 sm:p-6 md:p-8 border-b md:border-b-0 md:border-r border-white/10" style={{ backgroundColor: source.logoBg }}>
              <div className="flex flex-col items-center gap-1">
                <img src={LinkedinLogo} alt="LinkedIn" className="w-28 sm:w-36 md:w-44 object-contain" />
                <img src={LearningLogo} alt="Learning" className="w-24 sm:w-28 md:w-36 object-contain" />
              </div>
            </div>
            ...
            <div className="flex flex-col gap-3 p-5 sm:p-8" style={font}>
              <div>
                <p className="text-brand-cyan text-base sm:text-xl md:text-2xl font-bold uppercase tracking-wider">{source.source}</p>
                <p className="text-white/40 text-xs sm:text-sm mt-1">· {source.report}</p>
              </div>
              ...
              <p className="text-white/80 text-sm sm:text-base md:text-lg leading-relaxed">
                La <span className="text-brand-yellow font-bold text-base sm:text-xl md:text-2xl">Persuasión</span> es una de las habilidades más demandadas por empresas, y es una de las habilidades de poder más indispensables en el entorno profesional actual.
              </p>
            </div>
            ...
            <div className="flex items-center justify-center px-4 sm:px-8 py-4 md:py-0 border-t md:border-t-0 md:border-l border-white/10">
              ...
              >
                <span className="text-brand-yellow font-black text-lg sm:text-2xl">{source.rank}</span>
